...
const SYSTEM_PROMPT = [
  ...
  "Treat pointLoads, axialLoads, and pointMoments as separate tables.",
  "If the user asks to remove or clear point loads, clear only pointLoads unless they explicitly mention axial loads or moments.",
